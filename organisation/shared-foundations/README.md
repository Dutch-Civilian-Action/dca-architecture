...
Shared organisational meaning used across DCA domains, systems, interfaces, and AI.

This area contains stable cross-organisational principles and methods that should remain valid independently of a specific tool, platform, AI provider, team structure, or implementation.

It does **not** contain live operational evidence, day-to-day procedures, technical schemas, or a prematurely fixed Operating Model.
...
- `reconstruction-reconciliation-method.md` — how DCA turns distributed organisational and operational evidence, plus live capture, into reliable reusable shared organisational information while preserving provenance, uncertainty, validation boundaries, reader-usable source context, audience boundaries, and the required maintained-reality reconciliation handoff for established current findings.
- `evidence-validation-to-live-use-loop.md` — the practical recurring loop after evidence or validation: preserve, reconstruct, validate through operator-appropriate tasks, classify, route to the correct organisational home, implement only what is justified, test in live work, and feed new evidence back into the system.
...
A bounded domain, capability, or information workflow may advance as soon as its relevant evidence and requirement are sufficiently established. DCA does not need to finish organisation-wide reconstruction before supporting clear bounded needs.
